...
namespace Daemon.Modules {
    public class RamPerformanceCounterModule:IDisposable {
        ...
        public void Add(String unitKey,String processName){
            ...
            this.PerformanceCounterDictionary[unitKey]=new PerformanceCounter{CategoryName="Process",CounterName="Working Set",InstanceName=processName,ReadOnly=true};
        }
