...
goog.exportSymbol('proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf', null, global);
goog.exportSymbol('proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf', null, global);
 ...
 * @constructor
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.displayName = 'proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.repeatedFields_, null);
};
goog.inherits(proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.displayName = 'proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
/**
 * optional UnitSettingsProtobuf SettingsProtobuf = 12;
 * @return {?proto.wind.Entities.Protobuf.WebSocketMessages.UnitSettingsProtobuf}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.UnitProtobuf.prototype.getSettingsprotobuf = function() {
  return /** @type{?proto.wind.Entities.Protobuf.WebSocketMessages.UnitSettingsProtobuf} */ (
    jspb.Message.getWrapperField(this, proto.wind.Entities.Protobuf.WebSocketMessages.UnitSettingsProtobuf, 12));
};
...
/**
 * optional UnitSettingsProtobuf RunningSettingsProtobuf = 13;
 * @return {?proto.wind.Entities.Protobuf.WebSocketMessages.UnitSettingsProtobuf}
 */
...
proto.wind.Entities.Protobuf.WebSocketMessages.ClientOfferControlKeyProtobuf.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    supportattach: jspb.Message.getBooleanFieldWithDefault(msg, 5, false)
  };
...
/**
 * optional bool SupportAttach = 5;
 * @return {boolean}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.ClientOfferControlKeyProtobuf.prototype.getSupportattach = function() {
 ...
 * @return {!proto.wind.Entities.Protobuf.WebSocketMessages.ClientOfferControlKeyProtobuf} returns this
 */
proto.wind.Entities.Protobuf.WebSocketMessages.ClientOfferControlKeyProtobuf.prototype.setSupportattach = function(value) {
 ...
 * @return {!Object}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.prototype.toObject = function(opt_includeInstance) {
  return proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.toObject = function(includeInstance, msg) {
  var f, obj = {
    type: jspb.Message.getFieldWithDefault(msg, 1, 0),
    unitkey: jspb.Message.getFieldWithDefault(msg, 2, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf;
  return proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getType();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.prototype.getType = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf} returns this
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.prototype.setType = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.prototype.getUnitkey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf} returns this
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.prototype.setUnitkey = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.prototype.getCommandtype = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf} returns this
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.prototype.setCommandtype = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.prototype.getCommandline = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf} returns this
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachRequestProtobuf.prototype.setCommandline = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @const
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.repeatedFields_ = [5];
 ...
 * @return {!Object}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.prototype.toObject = function(opt_includeInstance) {
  return proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.toObject = function(includeInstance, msg) {
  var f, obj = {
    type: jspb.Message.getFieldWithDefault(msg, 1, 0),
    unitkey: jspb.Message.getFieldWithDefault(msg, 2, ""),
    executed: jspb.Message.getBooleanFieldWithDefault(msg, 3, false),
    noexecutemessage: jspb.Message.getFieldWithDefault(msg, 4, ""),
    outputlinearrayList: (f = jspb.Message.getRepeatedField(msg, 5)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf;
  return proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getType();
  if (f !== 0) {
    writer.writeInt32(
  ...
  f = message.getOutputlinearrayList();
  if (f.length > 0) {
    writer.writeRepeatedString(
      5,
      f
 ...
 * @return {number}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.prototype.getType = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf} returns this
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.prototype.setType = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.prototype.getUnitkey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf} returns this
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.prototype.setUnitkey = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.prototype.getExecuted = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 3, false));
};
 ...
 * @return {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf} returns this
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.prototype.setExecuted = function(value) {
  return jspb.Message.setProto3BooleanField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.prototype.getNoexecutemessage = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf} returns this
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.prototype.setNoexecutemessage = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};


/**
 * repeated string OutputLineArray = 5;
 * @return {!Array<string>}
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.prototype.getOutputlinearrayList = function() {
 ...
 * @return {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf} returns this
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.prototype.setOutputlinearrayList = function(value) {
 ...
 * @return {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf} returns this
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.prototype.addOutputlinearray = function(value, opt_index) {
 ...
 * @return {!proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf} returns this
 */
proto.wind.Entities.Protobuf.WebSocketMessages.AttachResponseProtobuf.prototype.clearOutputlinearrayList = function() {
  return this.setOutputlinearrayList([]);
};
